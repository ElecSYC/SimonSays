...
const simonbuttons = document.getElementsByClassName('section');
...
class Simon {
    constructor(simonbuttons, startbutton, round) {
        ...
        this.errorSound = new Audio('./sound/mistake.mp3');
        this.buttonSounds = [
            new Audio('./sound/Note1.mp3'),
            new Audio('./sound/Note2.mp3'),
            new Audio('./sound/Note3.mp3'),
            new Audio('./sound/Note4.mp3'),
        ]
    }
    ...
    //Muestra el puntaje en segundos
